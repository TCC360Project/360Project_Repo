...
public class Sensor {
	...
	/**
	 * Data chosen based off weather at Jess's house. To be used as initial data
	 * point.
	 */
	public Sensor() {
		theTemperature = 60;
	...
	/**
	 * Resets theRain amount for new day. Sets theTemperature,theHumidity, and
	 * theWind based off most recent sensor.
	 * 
	...
	public String toString() {
		return "Temperature: " + this.getTheTemperature() + " Humidity: " + this.getTheHumidity() + " Wind: "
				+ this.getTheWind() + " Rain: " + this.getTheRain();

	}

	/*
	 * Generates data for all sensors besides rain. Rain cannot decrease in a day.
	 */
